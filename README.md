...
- 모델에 대한 상세한 설명이 부족했다고 개인적으로 생각함
- 프론트엔드 구현에 대해서도 시간이 좀 더 있다면 더 세련되게 디자인할 수 있을거라는 아쉬움이 들었음
- 다른 팀의 전체적인 발표 스킬이 좋은 편이었는데 이번 기회를 토대로 해커톤 발표에는 어떠한 컨셉으로 발표를 해야하는지 딕션이라든가 말투, 발표 자료 구성 등을 잘 배웠다고 생각함 
